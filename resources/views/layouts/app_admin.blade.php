                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <ul class="navbar-nav me-auto mb-2 mb-md-0">
                            ...
                            @else
                                <li class="nav-item">
                                    <a class="nav-link {{ returnActive('Home', Route::currentRouteName()) }}" href="{{ route('admin-home') }}">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="configuracoes.html">Configurações Gerais</a></li>
                                        <li><a class="dropdown-item" href="politica-privacidade.html">Políticas de Privacidade</a></li>
                                        <li><a class="dropdown-item" href="logs.html">Logs de Eventos</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle {{ returnActive('Incidentes', Route::currentRouteName()) }}" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('incidents') }}">Consultar</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item">
...
function returnActive($menu, $currentPage)
{
    if (
        ...
        (in_array($currentPage, ['incidents']) && $menu == 'Incidentes') ||
        ...
        (in_array($currentPage, ['incident-stage5']) && $menu == 'Incidentes')
        ) {
        return 'active';
    }
}
